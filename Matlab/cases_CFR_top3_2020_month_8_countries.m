...
hold on;
% Add white contour lines as guides for number of death
contour(X, Y, Z, [5e3, 1e4, 5e4], 'LineColor', 'w', 'LineWidth', 1);
% Add text annotations
text(0.021, 2.55e5, '5k', 'Color', 'w')
text(0.021, 5e5, '10k', 'Color', 'k')
text(0.0275, 1.95e6, '50k', 'Color', 'w')
text(0.033, 1.2e6, {'\leftarrow Ischemic', '     heart disease'}, 'Color', 'k')
text(0.041, 6.5e5, {'\leftarrow Stroke'}, 'Color', 'k')
text(0.040, 2e5, {"\leftarrow Alzheimer's", '     disease'}, 'Color', 'k')
hold off;
title('Russia')
% Change x-axis values to percentages
xticks(linspace(xmin, xmax, 5));
...
contour(X, Y, Z, [5e3, 1e4, 5e4], 'LineColor', 'w', 'LineWidth', 1);
% Add text annotations
text(0.0215, 2.45e5, '5k', 'Color', 'w')
text(0.0215, 4.9e5, '10k', 'Color', 'k');
text(0.072, 7.35e5, '50k', 'Color', 'w');
text(0.026, 5.7e5, {'\leftarrow Ischemic', '     heart disease'}, 'Color', 'k')
text(0.036, 3e5, {'\leftarrow Stroke'}, 'Color', 'k')
text(0.045, 1.85e5, {'     Lower', '\leftarrow respiratory', '     infection'}, 'Color', 'k')
hold off;
title('Brazil')
% Change x-axis values to percentages
xticks(linspace(xmin, xmax, 5));
