...
% be for COVID-19 to be one of the top 3 (level 3) causes of death (in 2021)
% 
...
text(0.0059, 8.3e6, {'\leftarrow Ischemic heart', '     disease'}, 'Color', 'k', 'FontSize', 9)
text(0.0055, 3e6, {'\leftarrow Tracheal, bronchus,', '     and lung cancer'}, 'Color', 'k', 'FontSize', 9)
text(0.021, 8.7e5, {'\leftarrow Stroke'}, 'Color', 'k', 'FontSize', 9)
hold off;
title('United States')
...
% Add text annotation to label causes of death
text(0.0041, 3.6e6, {'\leftarrow Ischemic heart', '     disease'}, 'Color', 'k', 'FontSize', 9)
text(0.0069, 1.66e6, {'\leftarrow Stroke'}, 'Color', 'k', 'FontSize', 9)
text(0.0105, 7.0e5, {'\leftarrow Lower respiratory', '     infections'}, 'Color', 'k', 'FontSize', 9)
hold off;
title('Brazil')
% Change x-axis values to percentages
xticks([xmin, linspace(0.01, xmax, 5)]);
...
% Add text annotation to label causes of death
text(0.0036, 7.38e5, {'\leftarrow Ischemic heart', '     disease'}, 'Color', 'k', 'FontSize', 9)
text(0.0085, 2.94e5, {'\leftarrow Stroke'}, 'Color', 'k', 'FontSize', 9)
text(0.016, 1.4e5, {'\leftarrow Diabetes', '     mellitus'}, 'Color', 'k', 'FontSize', 9)
hold off;
title('South Africa')
% Change x-axis values to percentages
xticks([xmin, linspace(0.01, xmax, 5)]);
...
% Add text annotation to label causes of death
text(0.0061, 1.55e6, {'\leftarrow Ischemic heart', '     disease'}, 'Color', 'k', 'FontSize', 9)
text(0.0082, 4.39e5, {'\leftarrow Stroke'}, 'Color', 'k', 'FontSize', 9)
text(0.01175, 1.16e5, {'\leftarrow Hypertensive', '     heart disease'}, 'Color', 'k', 'FontSize', 9)
hold off;
title('Iran')
% Change x-axis values to percentages
xticks([xmin, linspace(0.01, xmax, 5)]);
...
% Add text annotation to label causes of death
text(0.00525, 1.76e6, {'\leftarrow Ischemic heart', '     disease'}, 'Color', 'k', 'FontSize', 9)
text(0.00625, 6.58e5, {'\leftarrow Lower respiratory', '     infections'}, 'Color', 'k', 'FontSize', 9)
text(0.01625, 2.77e5, {'\leftarrow Stroke'}, 'Color', 'k', 'FontSize', 9)
hold off;
...
% Add text annotation to label causes of death
text(0.0055, 7.68e6, {'\leftarrow Ischemic heart', '     disease'}, 'Color', 'k', 'FontSize', 9)
text(0.0105, 2.83e6, {'\leftarrow Stroke'}, 'Color', 'k', 'FontSize', 9)
text(0.00725, 6e5, {'\leftarrow Tracheal, bronchus,', '     and lung cancer'}, 'Color', 'k', 'FontSize', 9)
hold off;
title('Russia')
% Change x-axis values to percentages
xticks([xmin, linspace(0.01, xmax, 5)]);
...
% Add text annotation to label causes of death
text(0.0047, 4.0e7, {'\leftarrow Stroke'}, 'Color', 'k', 'FontSize', 9)
text(0.0085, 1.76e7, {'\leftarrow Ischemic heart', '     disease'}, 'Color', 'k', 'FontSize', 9)
text(0.013, 6.94e6, {'\leftarrow COPD'}, 'Color', 'k', 'FontSize', 9)
hold off;
title('China')
% Change x-axis values to percentages
xticks([xmin, linspace(0.01, xmax, 5)]);
...
% Add text annotation to label causes of death
text(0.0038, 3.57e7, {'\leftarrow Ischemic heart', '     disease'}, 'Color', 'k', 'FontSize', 9)
text(0.0067, 1.25e7, {'\leftarrow COPD'}, 'Color', 'k', 'FontSize', 9)
text(0.0135, 4.93e6, {'\leftarrow Stroke'}, 'Color', 'k', 'FontSize', 9)
hold off;
title('India')
% Change x-axis values to percentages
xticks([xmin, linspace(0.01, xmax, 5)]);
